...
export const LEAD_COLUMNS: ColumnDef[] = [
  ...
  { key: 'source', label: 'Source', sortKey: 'source', defaultVisible: true, sortable: true, editable: true, fieldType: 'select',
    options: [
      { value: 'walk_in', label: 'Walk-in' }, { value: 'website', label: 'Website' }, { value: 'referral', label: 'Referral' },
      { value: 'digital_marketing', label: 'Digital Marketing' }, { value: 'cold_call', label: 'Cold Call' },
      { value: 'exhibition', label: 'Exhibition' }, { value: 'partner', label: 'Partner' }, { value: 'other', label: 'Other' },
    ] },
...
export const PROJECT_COLUMNS: ColumnDef[] = [
  ...
  { key: 'system_size_kwp', label: 'Size (kWp)', sortKey: 'system_size_kwp', defaultVisible: true, sortable: true, editable: false, fieldType: 'number' },
  { key: 'system_type', label: 'System Type', sortKey: 'system_type', defaultVisible: true, sortable: true, editable: false, fieldType: 'select',
    options: [{ value: 'on_grid', label: 'On-Grid' }, { value: 'hybrid', label: 'Hybrid' }, { value: 'off_grid', label: 'Off-Grid' }] },
  { key: 'status', label: 'Status', sortKey: 'status', defaultVisible: true, sortable: true, editable: false, fieldType: 'badge' },
  { key: 'site_city', label: 'City', sortKey: 'site_city', defaultVisible: true, sortable: true, editable: false, fieldType: 'text' },
  { key: 'contracted_value', label: 'Contract Value', sortKey: 'contracted_value', defaultVisible: true, sortable: true, editable: false, fieldType: 'currency', format: 'currency' },
  { key: 'project_manager_name', label: 'PM', defaultVisible: true, sortable: false, editable: false, fieldType: 'text' },
