...
function base64ToArrayBuffer(b64: string): ArrayBuffer {
  // Normalize URL-safe Base64 to standard Base64 before calling atob.
 ...
 *
 * @param plaintext       The secret to encrypt (Sungrow app secret).
 * @param publicKeyBase64 The SPKI-format RSA public key, standard or URL-safe Base64.
 */
