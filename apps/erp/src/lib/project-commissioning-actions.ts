...
// TODO(NEVER-DO #14): this file is 520 LOC, just over the 500 line ceiling.
// A clean follow-up split would extract QC inspection actions into
// project-qc-actions.ts (~125 LOC), leaving this file purely about
// commissioning + the project-completion event emission.

// ── QC Inspection CRUD (V2 — structured 7-section form) ──
// Kept in this file because QC gates are the quality checkpoints that feed
// the commissioning report; they share the same "site quality" domain.
