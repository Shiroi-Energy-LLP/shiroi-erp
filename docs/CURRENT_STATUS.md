...
> **Last updated: 2026-07-16** — Zoho Books live API sync shipped to dev (mig 203; inbound pull of all finance entries + voucher-only write-back; `/settings/zoho-sync`; PR #10). Awaiting Vivek's Zoho self-client credentials for go-live. Spec `2026-07-16-zoho-live-api-sync-design.md`.
...
|-----|---------------|---------|
| **Dev** (`actqtzoxjilqnldnacqz`) | **203** (2026-07-16 — Zoho live API sync) | None |
